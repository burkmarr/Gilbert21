...
#Region " Nicely formatted well-known properties "
    ...
    Public ReadOnly Property OrientationString() As String
        'Added by RJB
        Get
            Return [Enum].GetName(GetType(Orientations), Me.Orientation)
        End Get
    End Property
    ...
    Public ReadOnly Property ExposureProgramString() As String
        'Added RJB
        Get
            Return [Enum].GetName(GetType(ExposurePrograms), Me.ExposureProgram)
        End Get
    End Property
    ...
    Public ReadOnly Property ExposureMeteringModeString() As String
        'Added RJB
        Get
            Return [Enum].GetName(GetType(ExposureMeteringModes), Me.ExposureMeteringMode)
        End Get
    End Property
    ...
    Public ReadOnly Property FlashModeString() As String
        'Added RJB
        Get
            Return [Enum].GetName(GetType(FlashModes), Me.FlashMode)
        End Get
    End Property
    ...
    Public ReadOnly Property LightSourceString() As String
        'Added RJB
        Get
            Return [Enum].GetName(GetType(LightSources), Me.LightSource)
        End Get
    End Property
